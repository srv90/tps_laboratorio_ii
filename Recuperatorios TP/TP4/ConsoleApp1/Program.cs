...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Socio socio7 = new Socio("pepe", "zzzzz", 'm', 000001, Socio.EPase.Libre, Socio.EStatus.Activo, Socio.EPago.Credito);
            ...
            //Console.WriteLine(socioDAO.EliminarSocio(5));

            ///Rescato socios de la bbdd
            gimnasio.lista = socioDAO.ListarSocios();

            ///Edito el primer socio del listado
            Socio socio = gimnasio.lista[0];
            socio.Apellido = "Saraza";                
            Console.WriteLine(socioDAO.EditarSocio(socio));

            foreach (var item in gimnasio.lista)
            {
            ...
            //    {
            //        Console.WriteLine(socioDAO.GuardarSocio(item));
